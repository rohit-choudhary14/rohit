<%-- 
    Document   : upload_music_picture
    Created on : 15 Mar, 2022, 12:43:12 AM
    Author     : rohit
--%>
<%-- 
    Document   : upload_music
    Created on : 13 Mar, 2022, 3:30:56 AM
    Author     : rohit
--%>
...
if(email!=null){
                ...
                if(request.getParameter("code").length()!=0 && request.getParameter("album_code").length()!=0){
                    song_code=request.getParameter("code");
	...
	<section class="wrapper">
		...
		<div class="container-fluid">
                       ...
                       <div class="row" style="margin-top:10%">
                           ...
                           <div class="col-sm-7"><strong style="font-size:30px">Upload Cover</strong></div>
                     ...
                     <div class="login-form">
                     <form method="post" ACTION="upload_music__picture_process.jsp?code=<%=song_code%>&album_code=<%=album_code%>"  name="uploadForm" ENCTYPE='multipart/form-data'>
