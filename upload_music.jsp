	...
	<section class="wrapper">
		...
		<div class="container-fluid">
                       ...
                       <div class="row" style="margin-top:10%">
                           ...
                           <div class="col-sm-7"><strong style="font-size:30px">ADD SONG</strong></div>
                     ...
                     <div class="login-form">
                     <form method="post" ACTION="upload_music_process.jsp?code=<%=song_code%>&album_code=<%=album_code%>"  name="uploadForm" ENCTYPE='multipart/form-data'>




		      <div class="form-group">
	             <label class="text-center"><h4>Add song:</h4></label>
