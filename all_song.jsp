        ...
        var song_code=$(this).attr("rel");
          ...
          var album_code=$(this).attr("rel2");
           ...
           var src="mp3_song/"+song_code+".mp3";
            ...
            $("#fixed-content-expand").html("<div class='card'><table ><tr><td><center><img src='' style='width:300px;height:100px;'class='img-fluid' alt='Cinque Terre'  id='img'></center></td></tr><tr><td><audio  class='audio' controls><source src='' type='audio/mpeg' autoplay id='play'></audio></tr></td><tr><td><div class='col-sm-12' style='background-color:black;height:2px'></div></td></tr> <tr style='width:50px'><td ><span id='title' style='color:black;font-size:25px'></span><i class='fa fa-heart'style='color:white;font-size:25px' rel='' rel1=''></i></td></tr></table></div>");
            $("#play").attr("src",src);
            $("#img").attr("src",src1);
            $("#title").text(title);
