<%-- 
    Document   : show_album
    Created on : 12 Mar, 2022, 10:52:29 PM
    Author     : rohit
--%>
                                   ...
                                   <%
                                                                  ...
                                                                  String album_code=" ";
                                                                    ...
                                                                    try{
                                                                        ...
                                                                        ResultSet rs=st.executeQuery("select * from album where email='"+email+"' AND cat_code='"+cat_code+"'");  
                                                                          if(rs.next()){
                                                                            ...
                                                                            response.sendRedirect("all_album.jsp?code="+cat_code); 
                                                                              ...
                                                                              response.sendRedirect("Add_album.jsp?code="+cat_code);
